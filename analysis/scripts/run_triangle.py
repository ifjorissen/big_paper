...
def main():
  ...
  for f in glob.iglob(PATTERN):
    ...
    all_results = RESULTDIR + "triangle_all_base"+ base + EXT
    all_DT_results = RESULTDIR + "del_tri_all_base"+ base + EXT

    trivor_results = RESULTDIR + "triangle_base"+ base + "_ord" + order+ EXT
    del_res = RESULTDIR + "del_tri_base_" + base + "_ord" + order+ EXT
